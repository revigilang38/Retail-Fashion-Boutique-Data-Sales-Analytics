...
# load model
model = joblib.load("gb_tuned_pipeline.pkl")
...
def run():
    ...
    st.subheader(
        'Halaman ini akan berisi terkait dengan Prediksi Return Rate Fashion Boutique Data Sales Analytics 2025')
    st.markdown('---')
    ...
    if submit:
        ...
        st.markdown(f'Prediction Return Rate:  {result[0]: .2f}')
